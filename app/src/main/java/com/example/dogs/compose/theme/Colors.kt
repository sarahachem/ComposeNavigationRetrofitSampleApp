package com.example.dogs.compose.theme
...
internal object ThemeColorAlias {
    ...
    val textSecondary = ThemedColor(light = ColorAlias.black, dark = ColorAlias.disabledGrey)
    ...
    val divider = ThemedColor(light = ColorAlias.veryLightGrey, dark = ColorAlias.darkGrey)
